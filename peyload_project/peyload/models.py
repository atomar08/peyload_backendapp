...
# Git repo: https://github.com/mitchtabian/CodingWithMitch-Blog-Course/tree/master/src

#anjali.tomar.csu@gmail.com
#peyload8

class PeyloadUserManager(BaseUserManager):
...
class Account(AbstractBaseUser):
    ...
    objects = PeyloadUserManager()

    def __str__(self):
        return self.email + " " + self.first_name + " " + self.last_name + " " + self.phone_no
